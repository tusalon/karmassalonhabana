...
const urlsToCache = [
  ...
  '/karmassalonhabana/admin.html',
  '/karmassalonhabana/admin-login.html',
  '/karmassalonhabana/calendar.html',
  '/karmassalonhabana/setup-wizard.html',
  '/karmassalonhabana/editar-negocio.html',
  '/karmassalonhabana/manifest.json',
  '/karmassalonhabana/icons/icon-72x72.png',
  '/karmassalonhabana/icons/icon-96x96.png',
  '/karmassalonhabana/icons/icon-128x128.png',
  '/karmassalonhabana/icons/icon-144x144.png',
  ...
  '/karmassalonhabana/utils/push-config.js',
  '/karmassalonhabana/utils/push-notifications.js'
];
      ...
      .catch(() => {
        ...
        return caches.match(event.request).then(cachedResponse => {
          ...
          if (event.request.url.match(/\.(jpg|jpeg|png|gif|svg|webp)$/)) {
            return caches.match('/karmassalonhabana/icons/icon-192x192.png');
          }
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/karmassalonhabana/icons/icon-192x192.png',
    badge: '/karmassalonhabana/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/karmassalonhabana/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/karmassalonhabana/admin.html';
  event.waitUntil(
...
console.log('✅ Service Worker configurado para Karma’s Salón Habana');
